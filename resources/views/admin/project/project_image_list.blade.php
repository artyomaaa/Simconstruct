...
@endsection
@section('page-name', 'Project_Image_list')
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <a href="" class="btn btn-danger pull-right btn-sm" role="button" data-target="#centralModalSuccess"
                       data-toggle="modal"
                       style="margin: -5px;">Add new Project_Image</a>
                </div>
                        ...
                        @if(isset($project_images))
                            @foreach($project_images as $project_image)
                                <tr class="odd gradeX">
                                    ...
                                    <td>{{ $project_image->project->project_name }}</td>
                                    <td>
                                        <img src="{{asset('assets/images/'.$project_image->image_path)}} "
                                             style="width:50px; height: 50px">

                                    </td>
                                    <td><a href="" class="btn btn-info btn-sm" role="button" data-toggle="modal"
                                           data-target="#exampleModal-{{$project_image->id}}"><i
                                                    class="fa fa-edit fa-fw"></i> edit
                                        </a></td>
                                    <td>
                                        <form action="{{route('projectimage-delete',$project_image->id)}}" method="post"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="background-color: #686868">
                <div class="text-center">
                    ...
                    <br><br>
                    <div class="form-group">
                        <form id="form_projects_image" enctype="multipart/form-data">
                            @if(isset($projects) && is_object($projects))
                                <div class="form-group">
                                    <label for="project">Enter Project_Image</label>
                                    ...
                                    <span style="color: red" class="error project_id-error"></span>
                                </div>
                                <div class="form-group">
                                    <input type="file" name="image_path[]" multiple class="form-control">

                                    <span style="color: red" class="error image_path-error"></span>
            ...
            <!--Footer-->
            <div class="modal-footer justify-content-center" style="background-color: #686868">
                <a type="button" class="btn btn-success waves-effect waves-light" id="add_project_image_btn">Save image
                    <i class="far fa-gem ml-1 text-white"></i>
                </a>
